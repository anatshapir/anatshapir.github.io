...
export const staticMaterials: StaticMaterial[] = ([
  ...
  },
  {
    ...
    description: '',
    category: 'teaching',
    path: ['מדעי המחשב', 'מה זה בעצם מדעי המחשב'],
  ...
  },
  {
    id: 'numpy-מחברת',
    title: 'Numpy - מחברת',
    description: 'מחברת הסבר ותרגול',
    category: 'teaching',
    path: ['מדעי הנתונים', 'ספריות'],
    linkUrl: 'https://colab.research.google.com/github/anatshapir/anatshapir.github.io/blob/main/docs/04 NumPy Notebook.ipynb',
    icon: '📓',
  },
  {
    id: 'pandas-מחברת',
    ...
    category: 'teaching',
    path: ['מדעי הנתונים', 'ספריות'],
    linkUrl: 'https://colab.research.google.com/github/anatshapir/anatshapir.github.io/blob/main/docs/NB04_Pandas_DataFrames_IMPROVED.ipynb',
    icon: '📓',
  },
  {
    id: 'שפת-מכונה-לשפות-תכנות',
    title: 'שפת מכונה לשפות תכנות',
    description: '',
    category: 'teaching',
    path: ['מדעי המחשב', 'מה זה בעצם מדעי המחשב'],
    linkUrl: '/שפת_סף__לדבר_עם_המכונה.mp4',
    icon: '🎬',
  },
  {
    id: 'eda-מחברת',
